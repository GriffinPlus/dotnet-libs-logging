...
namespace GriffinPlus.Lib.Logging.Collections
{
	...
	public class SelectableFileBackedLogMessageFilterTests_ReadWrite_Recording_Robust : SelectableFileBackedLogMessageFilterTests_Base
	{
		/// <summary>
		...
		public SelectableFileBackedLogMessageFilterTests_ReadWrite_Recording_Robust(LogFileTestsFixture fixture) :
			base(
				fixture,
				false,
