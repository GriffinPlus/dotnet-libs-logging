...
namespace GriffinPlus.Lib.Logging.Collections
{
	...
	public class SelectableFileBackedLogMessageFilterTests_ReadOnly_Analysis_Robust : SelectableFileBackedLogMessageFilterTests_Base
	{
		/// <summary>
		/// Initializes an instance of the <see cref="SelectableFileBackedLogMessageFilterTests_ReadOnly_Analysis_Robust"/> class.
		/// </summary>
		/// <param name="fixture">Fixture providing static test data.</param>
		public SelectableFileBackedLogMessageFilterTests_ReadOnly_Analysis_Robust(LogFileTestsFixture fixture) :
			base(
				fixture,
				true,
