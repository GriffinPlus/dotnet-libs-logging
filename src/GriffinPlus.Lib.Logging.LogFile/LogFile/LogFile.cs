...
public partial class LogFile : IDisposable
{
	...
	/// <see langword="true"/> to create the specified log file, if it does not exist, yet;<br/>
	/// <see langword="false"/> to throw an exception, if the file does not exist.
	/// </param>
	/// <param name="fileMustNotExist">
	/// <see langword="true"/> if the specified file must not exist;<br/>
	/// otherwise, <see langword="false"/>.
	/// </param>
	/// <param name="purpose">Purpose of the log file determining whether the log file is primarily used for recording or for analysis.</param>
	/// <param name="writeMode">Write mode determining whether to open the log file in 'robust' or 'fast' mode.</param>
	/// <param name="isReadOnly">
	/// <see langword="true"/> to open the log file in read-only mode;<br/>
	/// <see langword="false"/> to open the log file in read/write mode.
	/// </param>
	...
	/// <exception cref="FileNotFoundException"><paramref name="createIfNotExist"/> is <see langword="false"/> and the specified file does not exist.</exception>
	/// <exception cref="MigrationNeededException">The log file is opened read-only. Cannot perform necessary migration.</exception>
	...
	/// <param name="purpose">Purpose of the log file determining whether the log file is primarily used for recording or for analysis.</param>
	/// <param name="writeMode">Write mode determining whether to open the log file in 'robust' or 'fast' mode.</param>
	/// <param name="messages">Messages to populate the new log file with (<see langword="null"/> if the log file should be empty).</param>
	...
	/// <summary>
	/// Gets a value determining whether the log file is opened for reading and writing (<see langword="false"/>) or
	/// for reading only (<see langword="true"/>).
	/// </summary>
	...
	/// </summary>
	/// <param name="usedOnly">
	/// <see langword="true"/> to get the name of log levels that are referenced by messages in the log file only;<br/>
	/// <see langword="false"/> to get all log level names (even if referencing log messages have been removed after clearing/pruning).
	/// </param>
	...
	/// <see langword="false"/> to remove processes, applications, log writers, log levels and tags as well (default).
	/// </param>
	/// <param name="compact">
	...
	/// </param>
	/// <param name="compact">
	/// <see langword="true"/> to compact the log file after removing log messages;<br/>
	/// otherwise, <see langword="false"/>.
	/// </param>
	/// <returns>
