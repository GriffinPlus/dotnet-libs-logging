...
namespace GriffinPlus.Lib.Logging
{
	...
	public class EventManagerTests : IDisposable
	{
		...
		public void Complete_WithoutSynchronizationContext()
		{
			...
			int regCount = EventManager<EventManagerEventArgs>.RegisterEventHandler(this, EventName, handler, null);
		...
		public void Complete_WithoutSynchronizationContext_FireImmediately()
		{
			...
			string testData = Guid.NewGuid().ToString("D");
			int regCount = EventManager<EventManagerEventArgs>.RegisterEventHandler(this, EventName, handler, null, true, this, new EventManagerEventArgs(testData));
			Assert.Equal(1, regCount);
			Assert.Equal(testData, eventData);
		...
		public void GetEventCallers_WithoutSynchronizationContext()
		{
			...
			EventManager<EventManagerEventArgs>.RegisterEventHandler(this, EventName, handler1, null);
			EventManager<EventManagerEventArgs>.RegisterEventHandler(this, EventName, handler2, null);
