...
namespace GriffinPlus.Lib.Logging
{
	...
	/// </summary>
	public abstract class ProcessingPipelineStageBaseTests<TStage> where TStage : ProcessingPipelineStage, new()
	{
		...
		/// - <see cref="ProcessingPipelineStage.AddNextStage(ProcessingPipelineStage)"/>
		/// - <see cref="ProcessingPipelineStage.NextStages"/>
		/// - <see cref="ProcessingPipelineStage.GetAllStages(System.Collections.Generic.HashSet{GriffinPlus.Lib.Logging.ProcessingPipelineStage})"/>
		/// </summary>
		[Fact]
