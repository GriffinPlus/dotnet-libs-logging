...
namespace GriffinPlus.Lib.Logging.Collections
{
		...
		where TMessage : class, ILogMessage
	{
		...
		private readonly List<WeakReference<FilteredLogMessageCollection<TMessage>>> mFilteredCollections = new List<WeakReference<FilteredLogMessageCollection<TMessage>>>();
		...
		private readonly Dictionary<string, int> mUsedLogWriterCounts       = new Dictionary<string, int>();
		private readonly Dictionary<string, int> mUsedLogLevelCounts        = new Dictionary<string, int>();
		private readonly Dictionary<string, int> mUsedTagsCounts            = new Dictionary<string, int>();
		private readonly Dictionary<string, int> mUsedApplicationNameCounts = new Dictionary<string, int>();
		private readonly Dictionary<string, int> mUsedProcessNameCounts     = new Dictionary<string, int>();
		private readonly Dictionary<int, int>    mUsedProcessIdCounts       = new Dictionary<int, int>();
