...
namespace GriffinPlus.Lib.Logging
{
	...
	public sealed class LogWriterTagSet : ITagSet
	{
		...
		private static readonly TagComparer        sComparer = new TagComparer();
		...
		public LogWriterTagSet(IEnumerable<LogWriterTag> tags)
		{
			...
			mTags = new List<LogWriterTag>(new HashSet<LogWriterTag>(tags, sComparer));
			mTags.Sort(sComparer);
			mHashCode = CalculateHashCode(mTags);
		}
		...
		public bool Equals(LogWriterTagSet other)
		{
			...
			return mTags.SequenceEqual(other.mTags, sComparer);
		}
