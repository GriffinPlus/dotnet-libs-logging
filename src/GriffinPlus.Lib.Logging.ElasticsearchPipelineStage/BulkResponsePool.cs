...
class BulkResponsePool
{
	...
	private readonly Stack<BulkResponse> mBulkResponseInstances = new();
	...
	private readonly Stack<List<BulkResponse.Item>> mBulkResponseItemListInstances = new();
	...
	private readonly Stack<BulkResponse.Item> mBulkResponseItemInstances = new();
	...
	private readonly Stack<BulkResponse.Item_Create> mBulkResponseItemCreateInstances = new();
	...
	private readonly Stack<BulkResponse.Item_Create_Shards> mBulkResponseItemCreateShardInstances = new();
	...
	private readonly Stack<BulkResponse.Item_Create_Error> mBulkResponseItemCreateErrorInstances = new();
