...
{
	/// <summary>
	/// Unit tests targetting the <see cref="LogLevelBitMask"/> class.
	/// </summary>
	public class LogLevelBitMaskTests
	{
		[Fact]
		public void Check_Special_Mask_Zeros()
		{
		...
		[Fact]
		public void Check_Special_Mask_Ones()
		{
		...
		public void Create_Bit_Masks(int size, bool initialBitValue, bool paddingValue)
		{
		...
		[InlineData(128, 15)]
		[InlineData(128, 31)]
		public void Set_Bit(int size, int bit)
		{
		...
		[InlineData(128, 15)]
		[InlineData(128, 31)]
		public void Clear_Bit(int size, int bit)
		{
		...
		public void Set_Bits(int size, int fromBit, int count, uint[] expectedMaskArray)
		{
			LogLevelBitMask mask = new LogLevelBitMask(size, false, false);
		...
		public void Clear_Bits(int size, int fromBit, int count, uint[] expectedMaskArray)
		{
			LogLevelBitMask mask = new LogLevelBitMask(size, true, false);
		...
		[InlineData(128, 126)]
		[InlineData(128, 127)]
		public void Is_Bit_Set(int size, int bit)
		{
			LogLevelBitMask mask = new LogLevelBitMask(size, false, true);
		...
		[InlineData(128, 126)]
		[InlineData(128, 127)]
		public void Is_Bit_Cleared(int size, int bit)
		{
			LogLevelBitMask mask = new LogLevelBitMask(size, true, false);
